    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="card-header py-2">
                <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> BUAT NEWS
                </h5>
            </div>
        </div>
    </section>
                            ...
                            <form action="{{ url('admin/news') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="date" id="name" name="tanggal" class="form-control" placeholder="Masukan Nama" required>
                                        @error('tanggal')
                                        <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" id="name" name="penulis" class="form-control" placeholder="Masukan Penulis" required>
                                        @error('penulis')
                                        <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                        @enderror
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <textarea class="form-control" name="deskripsi" id="summernote" cols="30" rows="8" required></textarea>
                                        @error('deskripsi')
