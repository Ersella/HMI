    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="card-header">
                <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> TAMBAH DATA SURAT MASUK
                </h5>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('komisariat/surat-masuk') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4">
                                        ...
                                        <input type="text" id="name" name="sumber" class="form-control" placeholder="Masukan Sumber" required>
                                        @error('sumber')
                                        <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                        @enderror
                                    </div>
