    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="card-header py-2">
                <h5 class="m-0 font-weight-bold text-dark" style="text-align:center; font-size: 25px"> TAMBAH DATA PENGURUS
                </h5>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('cabang/pengurus') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
