<x-module.cabang>
    ...
    <div class="card">
        <div class="card-body">
            <a href="{{ url('cabang/surat-keluar/create') }}" class="float-right btn btn-dark"><i class="fas fa-plus"></i> Tambah Data</a>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                <x-template.button.info-button url="cabang/surat-keluar" id="{{ $sk->id }}" />
                                <x-template.button.edit-button url="cabang/surat-keluar" id="{{ $sk->id }}" />
                                <x-template.button.delete-button url="cabang/surat-keluar" id="{{ $sk->id }}" />
                            </div>
                        </td>
