                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 744px; text-align: center;">
                                ...
                                <p class="m-0 mb-0 mt-0" style="font-size: 20pt; font-weight: bold; font-family: 'Verdana', Arial, sans-serif;">KORPS HMI-WATI (KOHATI)</p>
                                <p class="m-0 mb-0 mt-0" style="font-size: 22pt; font-weight: bold; font-family: 'Verdana', 'Times New Roman', Times, serif; color: #009C4B;">HIMPUNAN MAHASISWA ISLAM (HMI)</p>
                                <p class="m-0 mb-0 mt-0" style="font-style: italic; font-weight: bold; font-size: 11pt; font-family: 'Verdana', 'Times New Roman', Times, serif;">(Female Division Of Branch Executive Of Islamic University Students Assosiation)</p>
                                ...
                                <p class="m-0 mb-0 mt-0" style="font-size: 11pt; font-family: 'Verdana', 'Times New Roman', Times, serif;">Email : Kohatiketapang@gmail.com Cp. +62 896-7711-6428</p>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table border="0" cellpadding="1" style="width: 350px; line-height: 1.15;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="180"><span style="font-size: 12pt; font-family: 'Verdana', Arial, sans-serif; margin:0rem;">{{ $sk->no_surat }}</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><span style="font-size: 12pt; font-family: 'Verdana', Arial, sans-serif;">{{ $sk->lampiran }}</span></td>
                                        </tr>
                                        <tr>
                                            <td><span style="font-size: 12pt; font-family: 'Verdana', Arial, sans-serif;">Perihal</span></td>
                                            <td><span style="font-size: 12pt; font-family: 'Verdana', Arial, sans-serif;">:</span></td>
                                            <td><span style="font-weight:bold;text-decoration:underline;font-size: 12pt; font-family: 'Verdana', Arial, sans-serif;">{{ $sk->perihal }}</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">&nbsp;</td>
                                        </tr>
                            ...
                            <td valign="top">
                                <table border="0" style="width: 274px; margin-top: 60px; line-height: 1.15;">
                                    <tbody class="mt-4">
                                        ...
                                        <tr>
                                            <td><span style="font-size: 12pt; font-weight: bold; font-family: 'Verdana', Arial, sans-serif;">{{ $sk->tujuan }}</span></td>
                                            <td></td>
                                            <td>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><span style="font-weight:bold;text-decoration:underline;font-size: 12pt; font-family: 'Verdana', Arial, sans-serif;">Tempat</span></td>
                                            <td></td>
                                            <td>
                                            </td>
                                        </tr>
                        ...
                        <tr>
                            <td align="center" width="40%">
                                ...
                                <div style="width:4cm; height:2cm;">
                                    <img src="{{ url('/') }}/{{ $sk->ttd_kiri }}" alt="Cap" style=" height: auto;" />
                                </div>
                                <br>
                                <br>
                                <br>
                            ...
                            <td align="left" width="40%" style="margin-left: 100px;">
                                <!-- <p style="text-align: center; margin: 0;">
                                    <span style="">Ketapang, {{ $sk->hijriah }} H</span>
                                </p>
                                <hr style="border: 1px solid #000; width: calc(20px); margin-top: 5px; margin-bottom: 5px;">
                                <p style="text-align: center; margin: 0;">
                                    <span style="">{{ $sk->masehi }} M</span>
                                </p> -->
                                <p style="margin-bottom: 0;">
                                    <span style="font-size: 12pt; font-family: 'Verdana', 'Times New Roman', Times, serif;">Ketapang, <span style="font-size: 12pt; font-family: 'Verdana', 'Times New Roman', Times, serif; text-decoration: underline;">{{ $sk->tanggal_hijriah }}</span></span>
                                </p>
                                <p style="margin-left: 85px;">
                                    <span style="font-size: 12pt; font-family: 'Verdana', 'Times New Roman', Times, serif;">{{ $sk->tanggal_masehi }}</span>
                                </p>
                                <div style="text-align: left;">
                                    ...
                                    <div style="width:3cm; height:1.5cm;">
                                        <img src="{{ url('/') }}/{{ $sk->ttd_kanan }}" alt="Cap" style="width: 4cm; height: auto;" />
                                    </div>
                                    <br>
                                    <br>
