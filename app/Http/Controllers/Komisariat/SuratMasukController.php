...
class SuratMasukController extends Controller
{
    public function index()
    {
        ...
        return view('komisariat.surat_masuk.index', $data);
    }

    public function create()
    {
        return view('komisariat.surat_masuk.create');
    }

    public function show($id)
    {
        $surat_masuk = SuratMasuk::findOrFail($id);
        return view('komisariat.surat_masuk.show', compact('surat_masuk'));
    }

    public function edit($id)
    {
        return view('komisariat.surat_masuk.edit', [
            'surat_masuk' => SuratMasuk::findOrFail($id)
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('komisariat/surat-masuk')->with('success', 'Data Berhasil Ditambahkan');
    }
    ...
    public function update($id)
    {
        ...
        return redirect('komisariat/surat-masuk')->with('success', 'Data Berhasil Diedit');
    }
    ...
    function destroy($id)
    {
        ...
        $surat_masuk->delete();
        return redirect('komisariat/surat-masuk')->with('danger', 'Data Berhasil Dihapus');
    }
}
