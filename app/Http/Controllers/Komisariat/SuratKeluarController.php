...
class SuratKeluarController extends Controller
{
    public function index()
    {
        ...
        return view('komisariat.surat_keluar.index', $data);
    }

    public function create()
    {
        return view('komisariat.surat_keluar.create');
    }

    public function show($id)
    {
        $surat_keluar = SuratKeluar::findOrFail($id);
        return view('komisariat.surat_keluar.show', compact('surat_keluar'));
    }

    public function edit($id)
    {
        return view('komisariat.surat_keluar.edit', [
            'surat_keluar' => SuratKeluar::findOrFail($id)
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('komisariat/surat-keluar')->with('success', 'Data Berhasil Ditambahkan');
    }
    ...
    public function update($id)
    {
        ...
        return redirect('komisariat/surat-keluar')->with('success', 'Data Berhasil Diedit');
    }
    ...
    function destroy($id)
    {
        ...
        $surat_keluar->delete();
        return redirect('komisariat/surat-keluar')->with('danger', 'Data Berhasil Dihapus');
    }
}
